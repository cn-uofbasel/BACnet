...
class Lora_Feed_Layer:
    ...
    def __init__(self):
        ...
        self.sensor_feed = feed.FEED("Sensor_Feed.pcap", self.sensor_fid, self.sensor_signer, True)
        self.control_feed = feed.FEED("Control_Feed.pcap", self.control_fid, None, True)
