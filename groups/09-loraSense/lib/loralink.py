...
class LoraLink:
    def __init__(self, sda="P3", scl="P4", als="P20", frequency=5, mode=0, debug=0) 
        try:
        ...
        self.test_sensor_layer = SenseLink(sda=sda, scl=scl, als=als, frequency=frequency, mode=mode, debug=debug, feed_layer)
