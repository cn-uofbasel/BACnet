...
class Lora_Test_Sensor_Layer:
    ...
    def __init__(self, feed_layer):
        ...
        self.feed_layer.create_event(fid, "['Temperature', '30C']")
        self.feed_layer.create_event(cfid, "['Interval', '2s']")
        self.feed_layer.create_event(cfid, "['', '2s']")
        #self.feed_layer.create_event(cfid, "['Intervall', '1s']")
        ...
        subscribe_state = self.feed_layer.subscribe_control_feed(self.callback_new_events)
