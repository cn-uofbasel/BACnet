...
Einen Nutzer für mehrere Geräte zu haben ist rein vom Grundbau des BACnet Protokolls wie in der Einleitung bereits erwähnt nur sehr schlecht möglich. Ein Ansatz war, den ersten Feed als Benutzerfeed anzuerkennen und dann die restlichen Feeds mittels dem Benuzerfeeds zu authentifizieren. Ein Weiterer war, einfach auf allen Geräten den gleichen privaten Schlüssel zu haben, was aber zu Kollisionen führen kann (das Aufteilen der verketteten Liste in zwei unterschiedliche Stränge, was wiederum bedeuten würde dass der Feed in zwei verschiedenen Versionen existiert).
