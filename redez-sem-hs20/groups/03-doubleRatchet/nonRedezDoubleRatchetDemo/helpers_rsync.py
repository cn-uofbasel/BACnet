...
def send_rsync() -> None:
    os.system(f"rsync -av --exclude='*/' --exclude='*.txt' --exclude='*.py' {get_path_my_log()} {get_path_other_log().rstrip('/')}")
    pass
...
def setup() -> None:
    ...
    try:
        ...
        print("Created file for log file of partner. Please save the path to your partners log file.")
        exit()
    except OSError:
        pass
